...
function setSidebarIconView() {
  ...
  sidebarItem.appendChild(sidebarItemLabel)
      ...
      document.getElementById("sidebar2-top-box").insertBefore(sidebarItem,document.getElementById("add-button"));
    }else{
      document.getElementById("sidebar2-top-box").insertBefore(document.getElementById(`select-${elem}`),document.getElementById("add-button"));
    }
  }
